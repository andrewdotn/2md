...
thanks to surrogates, is terms a *grapheme*.
...
But it was also taking a bit over a second for the code that’s shipped to
...
can always add them by edit `squid.conf` and running `squid -k reconfigure`
