...
After trying out a number of unsuccessful hacks, I decided that the
complexity here justified introducing a new intermediate representation
called an OutputBlock, roughly corresponding to a paragraph.
